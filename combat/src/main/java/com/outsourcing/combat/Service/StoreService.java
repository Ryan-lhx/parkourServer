...
public interface StoreService {
    // 查询所有
    List<store> getStoreAll(Integer currentPage, Integer pageSize);

    // 根据id查询
    store getStoreById(Integer id, Integer currentPage, Integer pageSize);
    ...
    // 根据id删除商品
    Integer deleteStoreById(Integer id, Integer currentPage, Integer pageSize);
}
